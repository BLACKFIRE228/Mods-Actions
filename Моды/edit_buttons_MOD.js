...
<div style="float: left; width: calc(50% - 12px);">
  <span class="dbminputlabel">Components to alter</span><br>
...
<br><br><br><br>
  ...
  <span class="dbminputlabel">Change the name to</span><br>
  <input id="alterarnome" class="round" type="text">

  <br>

  <span class="dbminputlabel">Change the emoji to</span><br>
...
SUCCESS (Green)<br>
DANGER (Red)<br>
Or use a variable, example \${tempVars("cor")}</div>
`;
  },
