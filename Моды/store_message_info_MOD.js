...
<div style="padding-top: 8px;">
	...
	<select id="info" class="round" onchange="glob.onComparisonChanged(this)">
		...
		<option value="6">Is the Message Edited?</option>
    <option value="7">Is It Message TTS?</option>
    <option value="8">Message Attachment List</option>
		<option value="9">Message Edits</option>
		<option value="12">Message Reaction Count</option>
		<option value="13">List of Users Mentioned in the Message</option>
		<option value="14">Count of Users Mentioned in the Message</option>
		...
		<option value="18">Message Attachment Count</option>
		<option value="10">Message Server ID</option>
    <option value="19">Message Server</option>
    ...
    <option value="46">Interaction Author Discriminator</options>
...
<input id="embednumber" value="0" class="round" type="text">
